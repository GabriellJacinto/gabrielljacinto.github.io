...
// import { dashboardContentPageLayout, sharedPageComponents } from "../../../quartz.layout"
...
// export const DashboardPage: QuartzEmitterPlugin<Partial<FullPageLayout>> = (userOpts) => {
//   const opts: FullPageLayout = {
//     ...sharedPageComponents,
//     ...dashboardContentPageLayout,
//     pageBody: Content(),
//     ...userOpts,
//   }
...
//       const fps: FilePath[] = []
//       const allFiles = content.map((c) => c[1].data).filter((file) => file.frontmatter?.tags?.includes("dashboard")) // Only include files tagged with #dashboard
...
//         console.log(
//           chalk.yellow(
//             `\n[Dashboard] Warning: you seem to be missing an \`index.md\` home page file at the root of your \`${ctx.argv.directory}\` folder. This may cause errors when deploying.`,
//           ),
//         )
//       }
